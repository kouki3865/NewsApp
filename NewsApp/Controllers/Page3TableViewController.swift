...
class Page3TableViewController: UITableViewController {
    ...
    private func setupParser(){
        let urlString = "https://news.yahoo.co.jp/rss/categories/domestic.xml"
...
extension Page3TableViewController: SegementSlideContentScrollViewDelegate {
...
extension Page3TableViewController: XMLParserDelegate{
