...
class Page5TableViewController: UITableViewController {
    ...
    private func setupParser(){
        let urlString = "https://news.yahoo.co.jp/rss/categories/business.xml"
...
extension Page5TableViewController: SegementSlideContentScrollViewDelegate {
...
extension Page5TableViewController: XMLParserDelegate{
