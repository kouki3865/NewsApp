...
class Page2TableViewController: UITableViewController {
    ...
    private func setupParser(){
        let urlString = "https://news.yahoo.co.jp/rss/categories/local.xml"
...
extension Page2TableViewController: SegementSlideContentScrollViewDelegate {
...
extension Page2TableViewController: XMLParserDelegate{
