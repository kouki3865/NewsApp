...
class Page4TableViewController: UITableViewController {
    ...
    private func setupParser(){
        let urlString = "https://news.yahoo.co.jp/rss/categories/it.xml"
...
extension Page4TableViewController: SegementSlideContentScrollViewDelegate {
...
extension Page4TableViewController: XMLParserDelegate{
